...
- `docs/explanations/migration_guide.md` (new)
- Updated `README.md`
...
- Component Improvement Plan: `docs/explanations/component_improvement_plan.md`
...
- **Related Documents**:
  - `docs/explanations/component_improvement_plan.md`
  - `docs/explanations/hybrid_component_system_implementation.md`
  - `AGENTS.md`
