...
- `docs/explanations/phase5_testing_implementation.md` (this document)
...
- Embedded Resources Plan: `docs/explanations/embedded_resources_plan.md`
- Phase 1 Implementation: `docs/explanations/phase1_embedded_resources_implementation.md`
- Phase 2 Implementation: `docs/explanations/phase2_loaders_implementation.md`
- Phase 3 Implementation: `docs/explanations/phase3_cli_implementation.md`
- Phase 4 Implementation: `docs/explanations/phase4_configuration_implementation.md`
