...
- **Documentation**: Complete documentation in `docs/explanations/`
...
- **Design Document**: `docs/explanations/template_system_design.md`
- **Implementation Plan**: `docs/explanations/implementation_plan.md` (Phase 7.0)
