...
- Domain Layer: `docs/explanation/phase1_architecture_domain_implementation.md`
- Infrastructure Layer: `docs/explanation/phase2_ollama_infrastructure_implementation.md`
