...
- `docs/explanation/phase4_configuration_implementation.md` (XXX lines) - This document
...
- `docs/explanation/embedded_resources_plan.md` - Overall plan
- `docs/explanation/phase1_embedded_resources_implementation.md` - Phase 1 details
- `docs/explanation/phase2_enhanced_loaders_implementation.md` - Phase 2 details
- `docs/explanation/phase3_cli_init_implementation.md` - Phase 3 details
