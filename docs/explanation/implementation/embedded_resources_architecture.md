...
- Implementation Details: `docs/explanation/phase1_embedded_resources_implementation.md`
- User Guide: `docs/how_to/setup_custom_resources.md`
- Environment Variables: `docs/reference/environment_variables.md`
- Testing: `docs/explanation/phase5_testing_implementation.md`
...
- Original Plan: `docs/explanation/embedded_resources_plan.md`
- Phase Implementations: `docs/explanation/phase*_implementation.md`
